...
export async function installM8HomeCardScrollFixes() {
  ...
  // Scrolling belongs to the browser. Safari handles finger tracking, gesture
  // cancellation, momentum and transformed coordinate spaces more reliably than
  // a JavaScript pointer simulation can. A swipe scrolls; a stationary tap selects.
