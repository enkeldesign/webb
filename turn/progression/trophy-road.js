...
const TROPHY_ROAD_REWARD_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    icon: 'future',
    perkTitle: 'OVERDRIVE',
    perkDescription: 'The longer you drive fast and clean, the higher the speed cap becomes. Leaving the track or colliding resets it.',
    description: 'Unlock the Future Racer: built for advanced time trials.<br><strong>OVERDRIVE:</strong> The longer you drive fast and clean, the higher the speed cap becomes. Leaving the track or colliding resets it.'
  }),
  Object.freeze({
    id: 'rally-racer',
    title: 'RALLY RACER',
