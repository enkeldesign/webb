...
function installLowGraphicsSetting() {
  ...
  section.innerHTML = `
    ...
    <p id="m8LowGraphicsRestartNote">Uses lower resolution, no shadows, no contours and cheaper lighting. Antialiasing and all track scenery stay unchanged. Restart TURN to apply changes.</p>
