...
function installStylesheet() {
  ...
  stylesheet.href = `/turn/m8-home-fixed-layout.css?build=${buildKey}-m8.9-record-car-scale`;
...
export async function installM8HomeFixedLayout() {
  ...
  const { installM8HomeCardScrollFixes } = await import(
    `/turn/m8-home-card-scroll-fixes.js?build=${buildKey}-m8.9-record-car-scale`
  );
