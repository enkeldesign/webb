...
const TUNE = makeSection({
  name: 'tune',
  leadVoice: 'brass', bassVoice: 'warm', arpVoice: 'organ', drumKit: 'brush',
  lead: bars(
  ...
  bass: bars(
    'E3 - E3 E4 - B3 D4 - E3 - G3 B3 D4 B3 E4 -',
    'C3 - C4 G3 - C4 B3 - D3 - D4 A3 D4 F#4 A3 -',
    'E3 - E4 B3 D4 B3 G3 - E3 B3 E4 - D4 B3 G3 -',
    'C3 - G3 C4 B3 - D4 C4 D3 A3 D4 F#4 E3 B3 E4 -'
  ),
  arp: bars(
...
const CHORUS = makeSection({
  name: 'chorus',
  leadVoice: 'whistle', bassVoice: 'warm', arpVoice: 'mandolin', drumKit: 'brush',
  lead: bars(
