...
export function paceNotePlaybackDirection(direction) {
  return Math.sign(Number(direction) || 0) * PACE_NOTE_EAR_POLARITY;
}
...
export function paceNotePan(direction, amount = PACE_NOTE_PAN_AMOUNT) {
  ...
  return paceNotePlaybackDirection(direction) * panAmount;
}
