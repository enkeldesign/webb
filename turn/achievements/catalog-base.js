// Internal foundation for TURN's production achievement catalog.
// Runtime code should import ./catalog.js; this file intentionally contains only
// the base achievements that the production catalog extends.
import {
  TIME_TRIALS,
...
export const ACHIEVEMENTS = Object.freeze([
  ...
  Object.freeze({ id: 'listen-closely', category: CATEGORY.WAYS_TO_PLAY, trophies: 100, title: 'LISTEN CLOSELY', description: 'Set Sound balance to at least 75% Drive By Ear, then drive for ten seconds with Blank screen mode on.', recommendation: 'Recommended for non-visual driving: 90% Drive By Ear', icon: 'listen', progressMax: 10 }),
