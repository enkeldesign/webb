...
assert.match(showcaseSource, /catalog\.js\?revision=r253-supercar-release/,
...
assert.ok(Math.abs(getOverdriveSpeedMultiplier(2.5) - 1.025) < 1e-12);
assert.equal(getOverdriveSpeedMultiplier(5), 1.05);
