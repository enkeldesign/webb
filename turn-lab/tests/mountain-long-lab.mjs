...
assert.match(labWorld, /Dead Canyon tunnel mountain left/);
assert.match(labWorld, /Dead Canyon tunnel mountain right/);
assert.match(labWorld, /Dead Canyon tunnel mountain ridge/);
...
assert.match(labWorld, /const lateral = trackWidth \/ 2 \+ 35/);
