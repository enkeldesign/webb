...
assert.match(app, /gameplay-controls\.js\?revision=r255-flow-shift-accessibility/,
  'The recovery-safe FLOW SHIFT control must bypass stale production module caches');
