...
assert.match(mountainTerrain, /ROAD_EDGE_TRIM_WIDTH: 0\.48/);
assert.match(mountainTerrain, /Mountain asphalt outer road trim r3/);
assert.match(mountainTerrain, /trim\.userData\.turnRoadEdgeTrim = 'mountain'/);
