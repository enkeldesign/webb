...
assert.equal(
  ...
  `./vehicle/catalog.js?build=${release.cacheKey}&revision=r588-canonical-attributes`,
  'The main runtime must publish the current canonical vehicle handling catalog'
);
assert.equal(
  imports['./vehicle/catalog.js?build=20260720-r20'],
  `./vehicle/catalog.js?build=${release.cacheKey}&revision=r588-canonical-attributes`,
  'The Lot must use the same current canonical vehicle handling catalog'
);
