...
assert.match(lotWrapper, /lot-enhancement-runtime\.js\?revision=r223-training-car-taxi/,
...
assert.match(lotWrapper, /lot-showroom-experiment\.js\?revision=r223-training-car-taxi/);
...
assert.match(index, /\/turn\/garage\/lot-track-select\.js\?revision=r200-production-candidate"\s*:\s*"\/turn\/garage\/lot-track-select\.js\?revision=r223-training-car-taxi/);
assert.match(
  index,
...
assert.equal(
  ...
  '/turn/garage/lot-showroom-experiment.js?revision=r223-training-car-taxi',
