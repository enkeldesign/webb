...
for (const [html, target] of [
  [index, '/turn/vehicle/emergency-livery-models.js?revision=r222-awd-suv-paint'],
  [nextIndex, '/turn/vehicle/emergency-livery-models.js?revision=r222-awd-suv-paint']
]) {
  assert.match(
    html,
