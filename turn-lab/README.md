...
Bridge deck, rails and supports reuse the repository's Kenney City Kit Roads, Fantasy Town and Nature Kit assets. Added houses, forest, rock screens, light pools and road furniture use shared geometry or instancing. The lower village adds no dynamic lights and its house batches do not cast shadows.
...
4. Check the summit, descent, bridge, lower village, forest return and final climb as separate sections.
...
- LAB storage is isolated and does not seed data from production.
